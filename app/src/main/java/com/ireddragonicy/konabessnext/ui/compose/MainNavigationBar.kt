...
fun MainNavigationBar(
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            icon = { Icon(Icons.Filled.Edit, contentDescription = stringResource(R.string.nav_dashboard)) },
            label = { Text(stringResource(R.string.nav_dashboard)) },
            selected = selectedItem == 0,
            onClick = { onItemSelected(0) }
        )
        NavigationBarItem(
            icon = { Icon(Icons.Rounded.Science, contentDescription = stringResource(R.string.nav_stability)) },
            label = { Text(stringResource(R.string.nav_stability)) },
