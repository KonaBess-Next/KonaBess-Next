...
**Q: 旧版 KonaBess 可以工作，但 Next 版本无法识别我的芯片，为什么？**  
**A:** KonaBess Next 经过了彻底重写，使用了专为现代芯片（8 Gen 2/3, Elite）设计的新 DTS 解析器。在过渡期间，对旧平台或某些 OEM 定制版的支持可能会暂时出现问题。

**Q: 我的设备受支持吗？**  
**A:** 如果它在旧版应用上能用，那它*最终*也能在这里使用。现在，旧芯片组可能会有一些不稳定，我们正在完善新的解析器。

**Q: 它在我的设备上无法运行，我该怎么办？**  
**A:** 请在 [GitHub](https://github.com/KonaBess-Next/KonaBess-Next/issues) 上提交 Issue，并提供：
- 设备型号和 ROM 版本
- 芯片组型号（例如，SD865）
- 你的 `boot.img`, `dtbo.img`, 或 `.dtb` 文件
- 错误截图或日志

**Q: 我应该继续使用旧版吗？**  
**A:** 如果你现在就需要旧设备上的极致稳定，请使用旧版应用。如果你想尽早体验 Next 的 Material UI、无 Root 模式和曲线编辑器——请帮助我们测试并报告 Bug！
