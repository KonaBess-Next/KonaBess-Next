...
**В: Старая версия KonaBess работает, а Next не видит мой чип. Почему?**  
**О:** KonaBess Next написан с нуля с использованием нового парсера DTS, ориентированного на современные чипы (8 Gen 2/3, Elite). В переходный период поддержка старых процессоров или версий от конкретных производителей может быть временно нарушена.

**В: Поддерживается ли мое устройство?**  
**О:** Если оно работало в старом приложении, то оно будет работать здесь *со временем*. На данный момент, пока мы стабилизируем новый парсер, на старых чипсетах возможна нестабильность.

**В: Приложение у меня не работает. Что делать?**  
**О:** Создайте issue на [GitHub](https://github.com/KonaBess-Next/KonaBess-Next/issues) и укажите:
- Модель устройства и версию ROM
- Чипсет (например, SD865)
- Ваши файлы `boot.img`, `dtbo.img` или `.dtb`
- Скриншоты ошибки или логи

**В: Стоит ли мне остаться на старой версии?**  
**О:** Если вам нужна железобетонная стабильность на старом устройстве прямо сейчас — используйте старую версию. Если вы хотите первыми опробовать Material UI, работу без Root и редактор кривых в версии Next — помогите нам с тестированием и сообщайте о багах!
